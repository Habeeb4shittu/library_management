        ...
        <div class="details">
            ...
            <div class="funcs">
                <div>
                    ...
                    ?>
                    <?php if ($liked) { ?>
                        <span class="like red" data-id="<?= $book['id'] ?>" data-owner="<?= $book['owner_id'] ?>" onclick="Like()">
                            <i class="fas fa-heart" aria-hidden="true"></i>
                        </span>
                    <?php } else { ?>
                        <span class="like" data-id="<?= $book['id'] ?>" data-owner="<?= $book['owner_id'] ?>" onclick="Like()">
                            <i class="fas fa-heart" aria-hidden="true"></i>
                        </span>
                    <?php } ?>
                    <span class="read" data-book="<?= $book['book'] ?>"><i class="fab fa-readme"></i></span>
                </div>
                <button class="btn btn-success down-btn" data-book="<?= $book['book'] ?>" data-id="<?= $book['id'] ?>" data-owner="<?= $book['owner_id'] ?>">Download</button>
            </div>
        </div>
    </main>
    <div id="the-canvas">
